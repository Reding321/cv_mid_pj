# YOLOv3
## 该项目源自[WZMIAOMIAO/deep-learning-for-image-processing](https://github.com/WZMIAOMIAO/deep-learning-for-image-processing/tree/master/pytorch_object_detection/yolov3_spp)
## 1 环境配置：
* Python3.6或者3.7
...
* [yolov3spp-voc-512.pt](https://pan.baidu.com/s/1wO5jCPaeN2y02LtPLfslnw?pwd=hcnr)
 
## 5 数据集，本例程使用的是PASCAL VOC2012数据集
...
## 6 Model Path（下载后放入weights文件夹中）
* [best.pt](https://pan.baidu.com/s/1wO5jCPaeN2y02LtPLfslnw?pwd=hcnr)
